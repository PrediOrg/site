...
import { idlFactory } from './predi.did.js';
export { idlFactory } from './predi.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PREDI;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./predi.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the predi canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./predi.did.js")._SERVICE>}
 */
export const predi = createActor(canisterId);
